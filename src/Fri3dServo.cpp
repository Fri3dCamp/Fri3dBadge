...
int Fri3dServo::attach(int pin)
{
    return (this->attach(pin, DEFAULT_uS_LOW, DEFAULT_uS_HIGH));
}

int Fri3dServo::attach(int pin, int min, int max)
{    
